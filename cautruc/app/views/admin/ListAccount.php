                    ...
                    foreach($listAccount as $account){
                      ...
                      <tr>
                        ...
                        <td style="width:20%; text-align:center">
                          <img style="height:100px" src="'. $account["anh_tk"] .'" alt="">
                        </td>
                        <td style="width:20%;">'. $account["email_tk"] .'</td>
                        <td style="width:20%;">'. $account["mk_tk"] .'</td>
                        <td style="width:15%;">'. ($account["id_cv"]==1?"Admin":"Người dùng") .'</td>
                        <td>
                          <div class="btn-group custom-btns" role="group" aria-label="Basic example">
                            <a type="button" href="?url=editaccountadmin&id_tk='. $account["id_tk"] .'" class="btn btn-success">Sửa</a>
                            <button type="button" onclick="deleteAcount('. $account["id_tk"] .')" class="btn btn-danger">Xóa</button>
                          </div>
                        </td>
                      </tr>
                      ';
