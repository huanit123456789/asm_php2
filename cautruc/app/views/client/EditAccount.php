    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="container">
                        <form action="?url=editaccountclient" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="ten_nd">Họ và tên</label><span style="color:red; font-size:10px; margin-left:40px"><?= $_SESSION["validation"]["name"]??"" ?></span>
                                <input type="text" class="form-control" placeholder="Nhập họ và tên" name="ten" value="<?= $_POST["ten"]??$account["ten_tk"] ?>">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <img class="mt-2" id="preview" style="max-width: 50%; max-height: 150px;" src="<?= $account["anh_tk"] ?>">
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="password" class="form-control" name="mk" placeholder="Nhập mật khẩu">
                            </div>

                            <button type="submit" class="btn btn-primary mt-3" name="submit">Cập nhật tài khoản</button>
                        </form>
                    </div>
                </div>
            </div>
