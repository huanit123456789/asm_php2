        ...
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form method="POST" action="index.php?url=signupclient">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" name ="ten" id="form3Example3" class="form-control form-control-lg" value="<?= $_POST["ten"]??"" ?>" placeholder="Nhập họ và tên" />
                        </div>
                        ...
                        <div class="form-outline mb-3">
                            ...
                            <input type="password" name ="mk1" id="form3Example4" class="form-control form-control-lg"
                        ...
                        <div class="form-outline mb-3">
                            ...
                            <input type="password" name ="mk2" id="form3Example4" class="form-control form-control-lg"
                                placeholder="Xác nhận mật khẩu" />
                        </div>


                        <div class="text-center text-lg-start mt-4 pt-2">
                            <input type="submit" name="submit" value="Đăng ký" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;"></input>
                            <p class="small fw-bold mt-2 pt-1 mb-0">Bạn đã có tài khoản ?<a href="?url=signinclient"
