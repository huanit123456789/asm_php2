    ...
    <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form method="POST" action="<?= route("submitsigninclient") ?>">
                    ...
                    <div class="form-outline mb-3">
                        ...
                        <input type="password" name="matkhau_tk" id="form3Example4" class="form-control form-control-lg" placeholder="Nhập mật khẩu" />
                    </div>

                    <div class="d-flex justify-content-between align-items-center">
                        <!-- Checkbox -->
                        <div class="form-check mb-0"></div>
                        <a href="<?= route("forgotpass") ?>" class="text-body">Quên mật khẩu</a>
                    </div>

                    <div class="text-center text-lg-start mt-4 pt-2">
                        <input type="submit" name="submitsigninclient" value="Đăng nhập" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;"></input>
                        <p class="small fw-bold mt-2 pt-1 mb-0">Bạn chưa có tài khoản ?<a href="<?= route("signup") ?>" class="link-danger">Đăng ký</a></p>
                    </div>
