  ...
  <div class="container padding-bottom-3x mb-2 mt-5">
    <div class="row justify-content-center">
      <div class="col-lg-8 col-md-10">
        ...
        <form class="card mt-4" method="POST" action="<?= route("submitforgotpass") ?>">
          <div class="card-body">
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="email_tk" id="email-for-pass" require=""><small
          ...
          <div class="card-footer">
            <button class="btn btn-success" name="submitforgotpass" type="submit">Get New Password</button>
            <a class="btn btn-danger" href="<?= route("signinclient") ?>">Back to Login</a>
          </div>
        </form>
      </div>
    </div>
