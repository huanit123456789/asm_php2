...
<head>
    ...
    <script src="<?= BASE_URL . "public/javascripts/function.js" ?>"></script>
</head>
        ...
        <aside class="left-sidebar">
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="<?= route("homeclient") ?>" class="text-nowrap logo-img">
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= route("homeadmin") ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= route("listaccount") ?>" aria-expanded="false">
                                <span>
                                    <i class="ti ti-article"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= route("addaccount") ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= route("editprofileadmin") ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= route("logoutadmin") ?>" aria-expanded="false">
                                <span>
